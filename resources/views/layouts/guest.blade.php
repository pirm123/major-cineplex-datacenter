...
<head>
    ...
    <title>{{ config('app.name', 'Major Cinema Data Center') }}</title>
        ...
        <div class="auth-hero">
            <div class="auth-hero-inner">
                <div>
                    ...
                    <h1 class="auth-title">
                        {{ __('guest.title_line_1') }}<br>
                        <span>{{ __('guest.title_line_2') }}</span>
                        {{ __('guest.title_line_3') }}
                    </h1>
                ...
                <div>
                    <div class="auth-meta">
                        <div class="auth-meta-item">
                            ...
                            <span>{{ __('guest.feature_1') }}</span>
                        </div>
                        <div class="auth-meta-item">
                            <span class="auth-dot"></span>
                            <span>{{ __('guest.feature_2') }}</span>
                        </div>
                    </div>
